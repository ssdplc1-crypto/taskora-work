...
def activate_pay():
    ...
    # Flutterwave Standard checkout: CARD ONLY.
    # Keep optional customer fields out when they are empty; this avoids
    # Flutterwave rejecting the request with a generic "required parameters" error.
    customer = {
